...
import { backendHero, courseOutline, courseOutlineDropdown } from "./constants"; // Adjust the import path as needed
						...
						<div className="flex flex-col md:flex-row items-start gap-6 mt-[100px] bg-white">
							...
							<div className="w-full md:w-1/2 bg-[#A020F0]/10 p-4 md:p-8 rounded-xl min-h-[850px]">
								<div className="mb-8">
									...
									<p>
										Here is the course outline for backend
										engineering
									</p>
								</div>
