...
import { dataanalysisHero, courseOutline } from "./constants"; // Adjust the import path as needed
				...
				<div>
					...
					<div>
						<p
							...
							onClick={() => router.push("/learningpaths/data")}
						>
							<span> {" < "} </span>
							Go back
						</p>
					...
					<div>
						...
						<div className="flex flex-col items-center justify-center">
							<p className="text-center text-3xl font-bold mb-4">
								{dataanalysisHero.title}
							</p>
							<p className="mb-4 text-center w-full md:w-[80%]">
								{dataanalysisHero.description}
							</p>
							<Button
								className={"mb-4"}
								onClick={() => router.push("/enroll")}
							>
								{dataanalysisHero.buttonText}
							</Button>
						</div>
						<PriceCard />
						{/* main */}
						<div className="flex flex-col md:flex-row items-start gap-6 mt-[100px] bg-white">
							...
							<div className="w-full md:w-1/2 bg-[#A020F0]/10 p-4 md:p-8 rounded-xl min-h-[850px]">
								<div className="mb-8">
									...
									<p>
										Here is the course outline for Data
										Analysis
									</p>
								</div>
