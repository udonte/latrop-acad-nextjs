...
const TaskSubmitPopup = ({ isOpen, onClose }) => {
	...
	const isPDF = formData.file && formData.file.type === "application/pdf";
			...
			<div className="bg-white flex flex-col gap-6 rounded-lg p-4 sm:p-8 w-[90%] sm:w-[588px]">
				...
				<form onSubmit={handleSubmit} className="flex flex-col gap-6">
					<div className="flex flex-col gap-3">
						...
						<div className="flex flex-col gap-2">
							...
							{formData.file ? (
								<div className="relative flex flex-col w-full gap-2">
									<div className="flex justify-between items-center gap-3 px-4 py-3 h-[49px] cursor-pointer rounded-lg border border-[#2222221A]">
						...
						<p className="text-center font-semibold text-sm text-[#222222]">
							{SUBMITTASK.alternative.heading}
						</p>
						<div className="flex flex-col gap-2">
							<label className="text-sm text-[#555555]">
								{SUBMITTASK.alternative.input.label}
							</label>
							<input
								type={SUBMITTASK.alternative.input.type}
								name={SUBMITTASK.alternative.input.name}
								value={
									formData[SUBMITTASK.alternative.input.name]
								}
								onChange={handleChange}
								placeholder={
									SUBMITTASK.alternative.input.placeholder
								}
...
export default TaskSubmitPopup;
