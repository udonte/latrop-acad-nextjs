...
const TaskDropdown = ({ item, onSelect }) => {
	...
	return (
		<div className="relative flex flex-col w-full gap-2" ref={dropdownRef}>
			...
			{isOpen && (
				<ul className="absolute border bg-[#FFFFFF] top-full mt-[2px] rounded-lg w-full max-h-[270px] overflow-y-auto z-10">
