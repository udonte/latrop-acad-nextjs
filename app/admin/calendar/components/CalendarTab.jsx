...
const CalendarTab = () => {
  ...
  return (
    <div>
        ...
        <div className="bg-white mt-8 rounded-3xl overflow-hidden border border-gray-300">
          <Fullcalendar
            ...
            eventContent={(eventInfo) => (
              <div className="h-full flex items-center justify-center text-center text-[8px] px-2 lg:text-base">
      ...
      <EditNewEvent isOpen={isEditEventModalOpen} onClose={closeEditEvent} />
      <EventDetails
