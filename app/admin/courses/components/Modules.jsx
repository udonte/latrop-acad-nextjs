...
import {
	...
	VIDEO,
	VIDEOICON,
} from "@/app/lms/mycourses/constants";
...
const Modules = ({ course }) => {
	...
	return (
		<div className="py-3 px-3 md:py-6 md:px-4 lg:py-10 lg:px-10 bg-white rounded-lg border border-[#A020F01A] flex flex-col gap-">
			{course.map((module, index) => (
				<div
					key={index}
					className="flex flex-col gap-3 mb-4 border-b border-[#2222221A]"
				>
					...
					<TransitionGroup>
						{activeModule === index && (
							<CSSTransition timeout={500} classNames="faq">
								<div className="flex flex-col gap-3 pl-5 md:pl-20 pb-4 text-[#222222] text-sm md:text-base overflow-hidden transition-max-height duration-500 ease-in-out">
