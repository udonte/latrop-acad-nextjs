    ...
    <div className="container mx-auto relative">
      <div className="flex items-center md:justify-end mb-8 md:absolute md:top-[-50px] md:right-0">
        <div className="w-[300px] relative">
          ...
          />
          <input
            placeholder={"Search for student, email, or phone"}
                  ...
                  <td colSpan={6} className="text-center py-5">
                    ...
                    <div className="flex items-center justify-center w-full">
                      <div className="w-[300px] ">
                        <button
                          className="border-[1.5px] w-fit mt-4  buttons bg-[#A020F0] rounded-[5px] py-4 px-6 text-[#ffffff] text-[15px] leading-[20px] font-medium"
      ...
      <StudentDelete isOpen={deleteModalOpen} onClose={closeDeleteModal} />
      <StudentDetails isOpen={detailsModalOpen} onClose={closeDetailsModal} />
    </div>
  );
};
