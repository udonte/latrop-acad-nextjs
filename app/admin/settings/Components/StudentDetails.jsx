...
function StudentDetails({ isOpen, onClose }) {
    ...
    <>
      ...
      >
        <div className="w-full">
          <p className="text-xs">
            See the student details and turn on specific information here
          </p>
          {/* infor */}
          <div className="my-8">
          ...
          <div className="mt-8 flex items-center justify-center gap-4 pb-1">
